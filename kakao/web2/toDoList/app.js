(() => {
      ...
      379: (n, e, t) => {
        ...
        function u(n, e, t, o) {
          var r = t
            ...
            : o.css;
          if (n.styleSheet) n.styleSheet.cssText = l(e, r);
          else {
        ...
        n.exports = function (n, e) {
          ...
          return function (n) {
            if (
              ...
              for (var d = c(n, e), s = 0; s < t.length; s++) {
                var l = a(t[s]);
  ...
  (t.n = (n) => {
    ...
    (() => {
      const n = document.querySelector("#result");
      function e(e) {
        const t = e.map(
          (n, e) =>
        ...
        n.innerHTML = `<ul>${t.join("")}</ul>`;
      }
      const o = { id: "", text: "", isDone: !1 },
        ...
        a = function (n) {
          r.addEventListener("submit", (t) => {
            t.preventDefault();
            const r = i.value;
            "" !== r && (n.push({ ...o, text: r, isDone: !1 }), e(n));
          });
        };
      var c = t(379),
        d = t.n(c),
        s = t(176);
      d()(s.Z, { insert: "head", singleton: !1 }), s.Z.locals;
      const l = [
        { text: "JS공부기초", isDone: !0 },
        { text: "JS공부고급", isDone: !1 },
      ];
      a(l),
        e(l),
        document.querySelector("#result").addEventListener("click", (n) => {
          const { className: t } = n.target;
          if ("delete" == t) {
            const { index: t } = n.target.parentElement.dataset;
            l.splice(t, 1), e(l);
          } else if ("toggle-checked" == t) {
            console.log("hello");
            const { index: t } = n.target.parentElement.dataset;
            (l[t].isDone = !l[t].isDone), e(l);
          }
        });
    })();
})();
